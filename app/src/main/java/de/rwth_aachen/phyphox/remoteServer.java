    ...
    class exportCommandHandler implements HttpRequestHandler {
        ...
        public void handle(HttpRequest request, HttpResponse response,
            ...
            if (formatInt < 0 || formatInt >= experiment.exporter.exportFormats.length) {
                ...
                final File exportFile = experiment.exporter.exportDirect(experiment.exporter.exportFormats[formatInt], callActivity.getCacheDir(), fileName.isEmpty() ? "phyphox" : fileName);
